...
class ThreadTestCase(TestCase):
    ...
    def test_add_message_to_thread(self):
        self.thread.users.add(self.user1, self.user2)
        message1 = Message.objects.create(user=self.user1, content="muy buentas")
    ...
    def test_add_message_from_user_not_in_thread(self):
        self.thread.users.add(self.user1, self.user2)
        message1 = Message.objects.create(user=self.user1, content="mensaje 1")
        message2 = Message.objects.create(user=self.user2, content="mensaje 2")
